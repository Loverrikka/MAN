...
class MultiPartMemory(nn.Module):
    def __init__(self, cfg):
        ...
        self.temp = cfg.TMGF.MEMORY_BANK.PROXY_TEMP
        self.momentum = cfg.TMGF.MEMORY_BANK.MOMENTUM
        self.neg_k = cfg.TMGF.MEMORY_BANK.BG_KNN
        self.posK = cfg.TMGF.MEMORY_BANK.POS_K
        self.balance_w = cfg.TMGF.MEMORY_BANK.BALANCE_W
        self.part_weight = cfg.TMGF.MEMORY_BANK.PART_W
        self.num_parts = cfg.TMGF.MODEL.NUM_PARTS
